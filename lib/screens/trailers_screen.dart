          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'Search trailer # or name',
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snap) {
                  ...
                  if (docs.isEmpty)
                    return const Center(child: Text('No trailers'));
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ListTile(
                        leading: const CircleAvatar(
                            child: Icon(Icons.trailer_outlined)),
  ...
  Future<void> _openEditor({String? id, Map<String, dynamic>? initial}) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(id == null ? 'New Trailer' : 'Edit Trailer'),
        content: SizedBox(
          width: 480,
          child: Column(
    ...
    if (ok == true) {
      ...
      final col = FirebaseFirestore.instance.collection('trailers');
      if (id == null) {
        await col.add(data);
      } else {
